...
import com.ryryanb.shopupspot.service.QueriesService;
...
public class HomeController {
	...
	public String addQuery(@Valid @ModelAttribute(value = "contact") Query query, Model model, BindingResult result) {
